...
const study_material_update_schema = z.object({
...
export let update_course_body_schema = z.object({
    ...
    language: z.array(z.string()).optional().openapi({ example: ["English"] }),
    ...
    materials: z.array(study_material_update_schema).optional(),
